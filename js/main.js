...
function loadWeather() {
    ...
    if (zip === ''){zip="85045"};
    var conditionsPath = "http://api.wunderground.com/api/cadb4cbe85919ec8/conditions/q/"+zip+".json";
    var forecastPath = "http://api.wunderground.com/api/cadb4cbe85919ec8/forecast/q/"+zip+".json";
